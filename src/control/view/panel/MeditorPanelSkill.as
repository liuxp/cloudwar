package control.view.panel
{
	...
	public class MeditorPanelSkill extends ViewMeditorBase
	{
		private var _view:PanelHeroSkill;
		private var _sceneState:String;
		
		public function MeditorPanelSkill(viewUI:ViewBase, model:ModelBase=null)
		{
			_view = viewUI as PanelHeroSkill;
			super(viewUI, model);
		}
